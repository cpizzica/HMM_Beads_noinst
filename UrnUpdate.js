...
var pavlovia_init = {
     ...
     var script_picker = Math.floor((Math.random() * 100) + 1)
...
post_trial_gap: 100
    ...
    var Instruction_trial10 = {
	 ...
	 type: 'html-keyboard-response',
	 stimulus: centered_message('<p> As you observed, a white bead was pulled from the 80% white jar, the jars switched and a black bead was pulled from the 80% black jar, but then a low-probability white bead was pulled from the 80% black jar. <br><br>This means that the color of the bead will not always match to the color of the jar it was pulled from.<br><br> It will be up to you to use this information to predict the color of the next bead.<br><br>Press SPACEBAR to conitnue.</p>'),
	 choices: ['spacebar'],
	 prompt: ''
     }; 
    ...
    LHMM_text = '<p style="font-family:Arial;text-align:center;width:800px;font-size:20px">In this block, there will be a 1% chance that the jar on the next trial will be different from the jar on the current trial. <br><br> The jar on the left contains 80% black beads and 20% white beads. <br><br> The jar on the right contains 80% white beads and 20% black beads. <br><br> Press the SPACEBAR to continue.</p>'
 ...
 prompt: '',
  ...
  jsPsych.init({
    preload: [Low_HMMData, Low_MMData, High_HMMData, High_MMData],
	  timeline: [pavlovia_init, consentdemo_block, instruction_block, Load_trial, experiment_block, reset_trial, Load_trial, experiment_block, reset_trial, pavlovia_finish],
